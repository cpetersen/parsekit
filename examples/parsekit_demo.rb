...
puts "ParseKit Ruby - Document Parsing Demo"
puts "=" * 40
puts "This gem provides document text extraction with zero runtime dependencies."
puts ""
...
result = ParseKit.parse(text)
puts "   Input: #{text}"
puts "   Result: #{result}"
puts ""

# Example 2: Demonstrate what ParseKit is designed for
puts "2. Document parsing capabilities:"
puts "   ParseKit can extract text from:"
puts "   - PDF files (.pdf)"
...
if ARGV[0] && File.exist?(ARGV[0])
  ...
  begin
    extracted_text = ParseKit.parse_file(ARGV[0])
...
puts "   text = ParseKit.parse_bytes(data)"
puts "   ```"
